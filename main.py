...
top_left_x = (s_width - play_width) // 2 - 100
...
def draw_window(surface, grid, score, hscore):
    surface.fill((0, 0, 0))
    ...
    surface.blit(label, (sx + 10 + 60 - label.get_width() / 2, sy - play_height /2 + 100))
    ...
    sx = top_left_x + play_width + 50
    sy = top_left_y + play_height / 2 - 100
    pygame.draw.rect(surface, (255, 0, 0), (sx, sy, 5 * block_size, 5 * block_size), 4)
